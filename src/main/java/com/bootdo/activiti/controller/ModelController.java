...
public class ModelController extends BaseController{
     ...
     * @param deploymentId
     */
    public void addAll(String deploymentId){
        List<UserDO> list = userService.list(null);
        list.forEach(userDO -> {
            repositoryService.addCandidateStarterUser(repositoryService.createProcessDefinitionQuery().deploymentId(deploymentId).singleResult().getId()
                    , userDO.getUserId()+"");
        });
    }
